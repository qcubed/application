...
<div id="instructions">
	...
	<p>In QCubed, we sometimes may want events to stop bubbling up the DOM tree. To do this, we use <strong>\QCubed\Action\StopPropagation</strong>.</p>
	...
	<p>The second example shows how to stop the bubbling effect using <b>\QCubed\Action\StopPropagation</b>. When you click inside the innermost

...
<div id="instructions">
	<h1>\QCubed\Query\QQ and Reverse Relationships</h1>
	...
	<p><strong>QCubed Query</strong> also has this built-in capability, which works very similar to the way <strong>\QCubed\Query\QQ</strong> handles Associations.
	...
	association table).  Therefore <strong>\QCubed\Query\QQ</strong> has the ability to perform the full set of <strong>\QCubed\Query\QQ</strong> functionality
...
<?php
	...
	foreach ($objPersonArray as $objPerson) {
		printf('<li>%s %s (managing the "%s" project)</li>',
			...
			\QCubed\QString::htmlEntities($objPerson->_ProjectAsManager->Name), false);
	}
?>
	</ul>

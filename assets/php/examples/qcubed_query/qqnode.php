...
<div id="instructions" class="full">
	...
	<p><strong>\QCubed\Query\QQ Nodes</strong> are any object table or association table (type tables are excluded), as well as any
	column within those tables.  <strong>\QCubed\Query\QQ Node</strong> classes for your entire data model is generated for you
	during the code generation process.</p>

	<p>But in addition to this, <strong>\QCubed\Query\QQ Nodes</strong> are completely interlinked together, matching the relationships
	that you have defined as foreign keys (or virtual foreign keys using a relationships script) in your
	database.</p>

	<p>To get at a specific <strong>\QCubed\Query\QQ Node</strong>, you will need to call <strong>QQN::ClassName()</strong>, where "ClassName" is the name of the class
	...
	property and method names will also be reflected in the \QCubed\Query\QQ Nodes.  So just as <strong>$objProject->ManagerPerson</strong> will
	...
	<p>And of course, because <em>everything</em> that is linked together in the database is also linked together in your <strong>\QCubed\Query\QQ Nodes</strong>,

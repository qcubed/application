...
class ExampleForm extends \QCubed\Project\Control\FormBase {
	...
	protected function formCreate() {
		...
		$col->OrderByClause = \QCubed\Query\QQ::OrderBy(QQN::Person()->Id);	// The clause to use when the column header is first clicked.
		$col->ReverseOrderByClause = \QCubed\Query\QQ::OrderBy(QQN::Person()->Id, false); // The clause to use the second time the column header is clicked.
		...
		$col->OrderByClause = \QCubed\Query\QQ::OrderBy(QQN::Person()->FirstName, QQN::Person()->LastName);	// The clause to use when the column header is first clicked.
		$col->ReverseOrderByClause = \QCubed\Query\QQ::OrderBy(QQN::Person()->FirstName, false, QQN::Person()->LastName, false); // The clause to use the second time the column header is clicked.

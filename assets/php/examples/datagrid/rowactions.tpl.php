...
<div id="instructions">
	...
	<p>The <strong>\QCubed\Event\CellClick</strong> class lets you detect clicks on cells and rows in <strong>\QCubed\Project\Control\Table</strong> and
	<strong>\QCubed\Project\Control\DataGrid</strong> tables. This class attaches a JavaScript event to the table which detects clicks that
	...
	<p>The action parameter is a JavaScript code fragment whose 'this' variable is defined as the object clicked on.
		<strong>\QCubed\Event\CellClick</strong> also has some predefined constants that let you return the row index or
	...
	<p>In the example, you can click on any of the rows, and the id of the row clicked on will be past to the action.
		...
		The <strong>\QCubed\Event\CellClick</strong> reads that value and sends it to the action handler.</p>
</div>

...
<div id="instructions" class="full">
	...
	<p>With the understanding of how the <strong>Code Generator</strong> can generate your data
		...
		of how you can use the <strong>\QCubed\Project\Control\FormBase</strong> and <strong>QControl</strong> libraries to build out your
	...
	<p>Please note that it is <em>very important</em> that you have a good understanding of
		<strong>\QCubed\Project\Control\FormBase</strong> and <strong>QControls</strong> before moving forward, otherwise this section will
		be difficult to understand, and even more difficult to utilize.</p>

	<p>The next couple of pages will discuss the three main <strong>\QCubed\Project\Control\FormBase</strong>- and <strong>QControl</strong>-related
		components that the Code Generator generates code for:</p>

	<ul>
		<li>ModelConnector Classes</li>
		<li>DataGrid Connector Classes</li>
		<li>\QCubed\Project\Control\FormBase and \QCubed\Control\Panel Drafts</li>
	</ul>
</div>

...
<div id="instructions">
	...
	<p>Whereas before, we executed a <strong>\QCubed\Action\Server</strong> on the button's click, we have now changed
	that to a <strong>\QCubed\Action\Ajax</strong>.  Everything else remains the same.</p>

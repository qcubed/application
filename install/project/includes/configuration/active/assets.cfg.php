...
// The base directory pointing to the qcubed directory when pointing to it with a browser, not including the server part of the url
define ('QCUBED_URL_BASE', __VIRTUAL_DIRECTORY__ . __SUBDIRECTORY__ . '/vendor/qcubed');
define ('QCUBED_URL_ORM', QCUBED_URL_BASE . '/orm');
...
define ('__QCUBED_ASSETS__', __SUBDIRECTORY__ . '/vendor/qcubed/application/assets');
...
//define ('__JQUERY_EFFECTS__', ' http://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.js');

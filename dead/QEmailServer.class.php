<?php
     ...
     * NOTE:
     *
     * While this code probably still works to send email, it no longer makes sense to continue to develop an email
     * application in the QCubed framework, since there are many other standalone emailers on the net that are actively maintained.
     * Most other frameworks seem to use phpmailer.
     *
     *
     *
     *
